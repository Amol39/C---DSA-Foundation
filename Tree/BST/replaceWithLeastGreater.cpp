/*
Given an array of integer, replace every element with the least greater element on its right side in the array. if there are no greater elements on the right side, replace it with -1.

Input:-  8 3 10 1 6 9 14
Output:- 9 6 14 6 9 14 -1
*/
